...
class $AssetsImageGen {
  ...
  /// File path: assets/image/akkilisletme.png
  AssetGenImage get akkilisletme =>
      const AssetGenImage('assets/image/akkilisletme.png');

  /// File path: assets/image/taslar.png
  AssetGenImage get taslar => const AssetGenImage('assets/image/taslar.png');

  /// List of all assets
  List<AssetGenImage> get values => [akkilisletme, taslar];
}
...
class $AssetsSvgGen {
  ...
  /// File path: assets/svg/dance.svg
  SvgGenImage get dance => const SvgGenImage('assets/svg/dance.svg');
